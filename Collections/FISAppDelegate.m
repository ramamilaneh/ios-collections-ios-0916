...
-(NSArray *)arrayBySortingArrayDescending:(NSArray *)array {
    ...
    return [array sortedArrayUsingDescriptors:@[sortDes]];
}
-(NSArray *)arrayBySwappingFirstObjectWithLastObjectInArray:(NSArray *)array {
    NSMutableArray *new = [array mutableCopy];
    NSUInteger endIndex = [new count] -1;
    [new exchangeObjectAtIndex:0 withObjectAtIndex:endIndex];
    return [NSArray arrayWithArray:new];

}
-(NSArray *)arrayByReversingArray:(NSArray *)array {
    NSMutableArray *new = [array mutableCopy];
    NSUInteger endIndex = [new count]/2 ;
    NSUInteger lastIndex = [new count] - 1;
    for (NSUInteger i = 0; i< endIndex; i++) {
        [new exchangeObjectAtIndex:i withObjectAtIndex:lastIndex-i];
    }
    return new;
